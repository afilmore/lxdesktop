Detailled folder view :

FmFolderView is a GtkScrolledWindow :
...
The view mode is represented by FmFolderViewMode, 4 modes are supported,
icon, thumnails, compac and detailled list view.

The "view" member is an ExoTreeView.


The create_list_view function creates the detailled listview.
